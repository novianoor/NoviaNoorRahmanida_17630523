<div class="card">
	...
	<div class="card-body">
		...
		<!-- <div class="col-md-12"> -->
		<a href="?page=mahasiswa-add" class="btn btn-success mb-2">Tambah Data</a>
		<a href="../mahasiswa/mahasiswa_print.php" target="_blank" class="btn btn-primary mb-2">Cetak Data</a>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
								<a class="btn btn-sm btn-primary" href="?page=mahasiswa-edit&id=<?php echo $data['id']; ?>">Edit</a>
